...
const announcementTypes = [
  { value: 'announcement', label: '📢 Announcement', icon: Megaphone, color: 'bg-blue-500' },
  { value: 'thought', label: '💡 Thought of the Day', icon: Lightbulb, color: 'bg-yellow-500' },
  { value: 'motivation', label: '❤️ Motivation', icon: Heart, color: 'bg-pink-500' },
  { value: 'note', label: '✨ Note', icon: Sparkles, color: 'bg-purple-500' },
]
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className={cn(
                ...
                announcementTypes.find(t => t.value === formType)?.color || 'bg-blue-500',
                "text-white"
              )}>
                <div className="flex items-start gap-3">
                  {(() => {
                    const IconComp = announcementTypes.find(t => t.value === formType)?.icon || Info
                    return <IconComp className="h-5 w-5 flex-shrink-0 mt-0.5" />
                  })()}
                  <div className="flex-1 min-w-0">
